...
SEEDS = [
    ...
    # ADR-051: каркас PBS ред. 3 — 135 узлов с анкетами; стыки ушли на свою полку
    ("library_fragment", None, "18-каркас-pbs.json"),
    # ADR-052: полка интерфейсов — 26 стыков рёбрами дерева, анкета стыка
    ("library_fragment", None, "19-интерфейсы.json"),
    # ADR-052: архитектурная полка по Arcadia — OA · SA · LA поверх двух первых
