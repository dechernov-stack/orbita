...
// полнота к ступени маркером · базовых линий (последняя — именем и датой) ·
// действия пиктограммой. Колонки «выпусков» нет (ответ владельца 26.09):
// печать — не выпуск, а выпуск в системе не заводится.
        ...
        <table className="v2-table">
          <thead>
            <tr>
              ...
              <th title="базовые линии документа: неизменяемые срезы под именем точки">Базовых линий</th>
            ...
            {список.map((д) => {
              ...
              return (
                <tr key={д.code}>
                  ...
                  <td>
                    {д.baselines > 0
                      ? <><b>{д.baselines}</b><span className="v2-dim"> · последняя «{д.baseline_name}» · {д.baseline_at}</span></>
                      : <span className="v2-warn">0 · не базирован</span>}
                  </td>
