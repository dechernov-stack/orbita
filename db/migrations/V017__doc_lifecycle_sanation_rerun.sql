-- Повтор санации V016: мусор успел вернуться ОТКАТОМ (undo) — он
-- восстанавливал документ из истории как есть, без валидации, и сам
-- проставлял lifecycle всем видам. Undo починен (см. Editing.undo);
-- здесь вычищается то, что он вернул между V016 и починкой.
--
