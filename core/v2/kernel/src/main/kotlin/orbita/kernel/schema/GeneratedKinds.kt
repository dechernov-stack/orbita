...
object GeneratedKinds {
    ...
    val all: List<KindSpec> = listOf(
        ...
        KindSpec("project", "проект", Layer.L1, "1", "active|cancelled", listOf("name", "mission_class", "manager", "phase_current", "group", "example"), listOf("name", "mission_class", "manager", "phase_current", "group", "example", "knowledge_v2")),
        ...
        KindSpec("topic", "тема (предмет фактов до разрешения в сущность)", Layer.L2, "загрузка", "open|resolved", listOf("label"), listOf("label", "resolved_to", "scene", "merged_into")),
        ...
        KindSpec("synthesis_run", "запуск синтеза постановки из поля", Layer.L2, "любая", "queued|running|done|error", listOf("trigger", "slice_fingerprint", "proposals", "diff", "ontology_version"), listOf("trigger", "slice_fingerprint", "slice_size", "proposals", "diff", "ontology_version", "cached", "error")),
        ...
        KindSpec("verification_report", "верификация документа против поля", Layer.L5, "после сборки/базирования документа", "open|closed", listOf("document", "items", "at"), listOf("document", "baseline", "items", "at")),
    )
