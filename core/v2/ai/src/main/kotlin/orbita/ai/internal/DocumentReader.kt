...
""".trimIndent()
    ...
    /**
     * Канон написания и форм — дословно из истины (`normalization`). Перечень
     * однозначных предикатов — данные сверки фактов, а не правило написания:
     * в промпт он не идёт.
     */
    private fun канонНаписания(): String = GeneratedOntology.normalization.entries
        .filter { (ключ, _) -> ключ != "single_valued_predicates" }
