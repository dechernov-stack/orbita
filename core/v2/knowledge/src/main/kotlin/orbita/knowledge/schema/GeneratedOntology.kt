...
object GeneratedOntology {
    ...
    val normalization: Map<String, String> = mapOf(
        ...
        "contradictions" to "противоречие — только у однозначного (ответ владельца 26.09 — блокер ПМИ-8; правка Code в истине 26.09): (а) величина — у обоих фактов единица одной размерности, значения различны с учётом оператора после приведения к канону справочника («≤ 180 мин» и «≤ 120 мин» — спор, «≤ 180 мин» и «≤ 3 ч» — нет); (б) предикат закрытого перечня single_valued_predicates — разные значения; всё прочее многозначно: иное значение — ещё один элемент перечня, то же значение из другого источника — связь same_as, счётчиком «подтверждено N документами»; один документ себе не противоречит; смысловое противоречие («ТЗ требует того, что устав исключает») лексикой не ловится — только вердиктом чтения contradict с цитатами обеих сторон; противоречие к принятому факту — долг другого факта",
        "single_valued_predicates" to "роль · роль стороны · срок · срок вехи · дата · дата вехи · класс миссии · орбита · высота орбиты · наклонение · наклонение орбиты · класс QoS · класс обслуживания · класс QoS сервиса",
    )
