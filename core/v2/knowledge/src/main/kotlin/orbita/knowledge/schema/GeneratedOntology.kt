...
object GeneratedOntology {
     ...
     */
    const val ontologyVersion: String = "4c1bdc06bed357d1daa23da9b0da5269f540cec8cab26566f64b0e4a4f4bc8da"
    ...
    val reconciliation: Map<String, String> = mapOf(
        ...
        "manual_input" to "ручной ввод → кандидат-факт rank=expert → та же сверка: дубль (ключ, затем семантика по срезу понятия) · противоречие (conflict_on после нормализации) · соединение (supports/refines, must_link) · нехватка (must_link) — предложения с уверенностью и полем отличия; выполняет только человек",
