...
data class Fact(
    ...
    /**
     * Цитата блока документа, на которой факт стоит (шип 5 §3.2: «откуда —
     * документ · якорь ссылкой, раскрывает цитату»). Пусто — у ручного факта и
     * у прочитанного до того, как разбор стал класть цитату.
     */
