...
class SceneGateTest {
    ...
    fun `нужда, которую закрывает не сервис, выход сцены 6 не держит`() {
        ...
        assertNull(оценщик.why(проект, "each_need_has_service"), "нужда регулятора сцену 6 не держит")
        // Журнал ПМИ-7, З-07: сцена 4 сужается так же — цель покрывает нужды
        // получателей, а не поставщиков и регуляторов.
        assertNull(оценщик.why(проект, "each_need_has_goal"), "и сцену 4 она не держит")
