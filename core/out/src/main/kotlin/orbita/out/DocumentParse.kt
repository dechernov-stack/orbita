...
object DocumentParse {
    ...
    /**
     * Ф-08.3: метка достоверности утверждения в начале блока (семантика
     * владельца, дословно): [И] — внутренний документ (наш материал);
     * [В] — внешний источник, проверенный на указанную дату; [П] —
     * предлагаемая цель или инженерно-финансовое допущение, требующее
     * подтверждения. Метка ложится координатой в карту: допущение проекта
     * («1 млн терминалов») не путается с проверенным внешним фактом.
     */
