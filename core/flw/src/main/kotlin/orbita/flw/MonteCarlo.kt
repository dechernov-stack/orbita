...
class MonteCarloEngine(private val mapper: ObjectMapper = ObjectMapper()) {
     ...
     *   само множество отбирает вызывающий функцией [relaySetContacts] по
     *   режиму доставки. Интервал между этими контактами и определяет
     *   ожидание нисходящего канала в бюджете времени реакции C'.
     */
    fun run(
        scenarioRef: String,
